...
Baycast is moving prediction polling from betting to forecasting.

Today I’m looking for a few people to try the fixed `/activity` page and make one forecast on a fresh live question.

Open the activity view, pick anything you can reason about, make your call.
...
## 20-minute checklist to get 5 human forecasts today
