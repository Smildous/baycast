# Publish now: 44 live questions, May 14

Baycast is ready enough to share today.

The useful update is simple: there are now 44 live questions on Baycast, all open. BCP is still blind to the market. That is the story. Not a launch speech. Not a grand claim. Just a working prediction market with a clear gap and a reason for people to try it now.
...
The part that stands out to me: BCP is still blind.

There is no real market consensus yet. A few people can still move the early shape of the forecasts by showing up with better local knowledge.
...
Baycast is a place to write the claim down.

### 4

This is not a finished grand platform announcement.
...
If you have 5 minutes today, pick one question where you think the current probability is wrong.

Forecast it. Leave a short comment if the reason matters.

That is enough to make the market less blind.

[link]

## HN comment or update
...
If you try it, the most useful thing is simple: find one question where the probability looks wrong, make a forecast, and leave a short note if your reasoning would help others.
...
## 10-minute execution order

Minute 0 to 1: Open Baycast and copy the live link you want people to use. Use the homepage if there is no better filtered page.

Minute 1 to 2: Post the short X post. Do not rewrite it for another hour. The goal is to publish, not keep editing.

Minute 2 to 4: Post the five-post X thread. Put the link in post 1 and post 5.

Minute 4 to 6: Add the HN update where it fits best. If there is already a relevant thread or previous Show HN, use it as a comment. If not, save it for the next relevant HN opening rather than forcing a weak post.
...
Do not wait for a larger launch, better charts, a perfect landing page, or a cleaner explanation of BCP. The honest message is stronger: 44 questions are live, the market is still blind, and people with local knowledge can improve it now.
