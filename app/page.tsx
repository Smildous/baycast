    ...
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <section className="text-center py-16 space-y-6">
        <div className="inline-block px-3 py-1 rounded-full border border-border-dark text-text-secondary text-sm mb-2">
          Beta — Join the first forecasters
        </div>
        ...
        <p className="text-text-secondary text-xl max-w-2xl mx-auto">
          Baycast is a prediction polling platform. Submit your probabilities on open questions, track your Brier scores, and climb the leaderboard.
        </p>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-16">
        {[
          { label: 'Open questions', value: stats.questions, suffix: '' },
          { label: 'Registered forecasters', value: stats.users, suffix: '' },
          { label: 'Predictions submitted', value: stats.forecasts, suffix: '' },
        ].map((s) => (
      ...
      <section>
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-2xl font-outfit font-semibold">Trending questions</h2>
