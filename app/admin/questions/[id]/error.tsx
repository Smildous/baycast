...
export default function EditQuestionError({
  error,
  reset,
}: {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex flex-col items-center justify-center px-4 text-center">
      ...
      <h1 className="text-2xl font-outfit font-semibold mb-2">Failed to load question</h1>
      <p className="text-text-secondary mb-8 max-w-md">
        {error.message || 'An error occurred while loading the question for editing.'}
      </p>
